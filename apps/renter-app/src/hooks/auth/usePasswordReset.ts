...
export const usePasswordReset = () => {
  const sendResetPasswordOtpMutation = useMutation<
    ...
    unknown,
    FirstParameter<typeof AuthRntFlowApi.sendResetPasswordOtp>
  >({
    mutationFn: AuthRntFlowApi.sendResetPasswordOtp,
  });

  const resetPasswordMutation = useMutation<
    AxiosResponse<CommandResponse<boolean>>,
    unknown,
    FirstParameter<typeof AuthRntFlowApi.resetPassword>
  >({
    mutationFn: AuthRntFlowApi.resetPassword,
  });
