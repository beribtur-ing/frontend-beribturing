            ...
            <TableRow key={booking.id}>
              ...
              <TableCell>
                <Typography variant="body2" fontWeight="medium">
                  <Link to={`/properties/${booking.propertyId}`} style={{ textDecoration: 'none', color: 'inherit' }}>
                    {booking.propertyTitle}
                  </Link>
                </Typography>
              </TableCell>
              <TableCell>
                <Link to={`/users/${booking.lendeeId}`} style={{ textDecoration: 'none', color: 'inherit' }}>
                  {booking.lendeeName}
                </Link>
              </TableCell>
              <TableCell>
                <Link to={`/users/${booking.lenderId}`} style={{ textDecoration: 'none', color: 'inherit' }}>
                  {booking.lenderName}
                </Link>
              </TableCell>
              <TableCell>
              ...
              <TableCell>
                <Box>
                  <Typography variant="body2">{new Date(booking.startDate).toLocaleDateString()}</Typography>
              ...
              <TableCell>
                <IconButton size="small" onClick={(e) => handleMenuClick(e, booking.id)}>
